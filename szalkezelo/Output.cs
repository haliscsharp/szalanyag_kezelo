...
namespace szalkezelo
{
    static class Output
    {
        public static void createTestPdf()
        {
            ...
            gfx.DrawString("Rendelés", new XFont("Arial", 16), XBrushes.Black, new XPoint(page.Width / 2 - 40, 70));
            ...
            gfx.DrawString("SZ0003", font, XBrushes.Black, new XPoint(widthOffset + 125 + 3, heightOffset + 12));

            gfx.DrawRectangle(XPens.Black, widthOffset + 125, 15 + heightOffset, 125, 15);
            gfx.DrawString("2021.11.26.", font, XBrushes.Black, new XPoint(widthOffset + 125 + 3, heightOffset + 27));

            gfx.DrawRectangle(XPens.Black, widthOffset + 125, 30 + heightOffset, 125, 15);
            gfx.DrawString("2", font, XBrushes.Black, new XPoint(widthOffset + 125 + 3, heightOffset + 42));


            gfx.DrawRectangle(XPens.Black, 125 * 2 + widthOffset, heightOffset, 250, 45);


            gfx.DrawRectangle(XPens.Black, widthOffset, 45 + heightOffset, 250, 15);
            gfx.DrawString("Szálnyag megnevezése", font, XBrushes.Black, new XPoint(widthOffset + 3, heightOffset + 57));


            gfx.DrawRectangle(XPens.Black, widthOffset + 250, 45 + heightOffset, 125, 15);
            gfx.DrawString("Méret", font, XBrushes.Black, new XPoint(widthOffset + 253, heightOffset + 57));
            gfx.DrawRectangle(XPens.Black, widthOffset + 375, 45 + heightOffset, 62.5, 15);
            gfx.DrawString("Hossz", font, XBrushes.Black, new XPoint(widthOffset + 378, heightOffset + 57));
            gfx.DrawRectangle(XPens.Black, widthOffset + 437.5, 45 + heightOffset, 62.5, 15);
            gfx.DrawString("Mennyiség", font, XBrushes.Black, new XPoint(widthOffset + 440.5, heightOffset + 57));


            document.Save(@"D:\STUFF\test.pdf");
        }

        public static void rendelesOutput(string munkaszam, string rendelo_datum, string rendelo_surgosseg, string[,] raktarOutput)
        {
            System.Text.Encoding.RegisterProvider(System.Text.CodePagesEncodingProvider.Instance);
